...
const MyBusinessInormation = () => {
    ...
    const { name, month, days, hora_ini, hora_fin, public_rout } = mapDataMyBusinessShow(myBussinesData)
    console.log({ name, month, days, hora_ini, hora_fin, public_rout });
    ...
    return (
        ...
        <Card className='w-full md:w-1/2 m-auto'>
            ...
            <CardBody className='flex gap-4 divide-y divide-gray-200 dark:text-white dark:divide-gray-700'>
                ...
                <div className=' w-full pt-6 flex flex-col gap-2 '>
                    ...
                    <div className='flex flex-col md:flex-row gap-4 justify-center items-center ' >
                        ...
                        <Code className='overflow-hidden' color="primary" size="md" ref={ref}>{public_rout} </Code>
